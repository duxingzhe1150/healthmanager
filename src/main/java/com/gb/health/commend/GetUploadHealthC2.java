...
import com.gb.health.init.HealthEnum2.Education;
import com.gb.health.init.HealthEnum2.Insurance;
import com.gb.health.init.HealthEnum2.L_liveSport_count;
import com.gb.health.init.HealthEnum2.L_liveSport_minute;
import com.gb.health.init.HealthEnum2.LiveFood_bean;
import com.gb.health.init.HealthEnum2.LiveFood_dayKind;
import com.gb.health.init.HealthEnum2.LiveFood_egg;
import com.gb.health.init.HealthEnum2.LiveFood_fish;
import com.gb.health.init.HealthEnum2.LiveFood_fruit;
import com.gb.health.init.HealthEnum2.LiveFood_meat;
import com.gb.health.init.HealthEnum2.LiveFood_milk;
import com.gb.health.init.HealthEnum2.LiveFood_nut;
import com.gb.health.init.HealthEnum2.LiveFood_oil;
import com.gb.health.init.HealthEnum2.LiveFood_potato;
import com.gb.health.init.HealthEnum2.LiveFood_primary;
import com.gb.health.init.HealthEnum2.LiveFood_salt;
import com.gb.health.init.HealthEnum2.LiveFood_structure;
import com.gb.health.init.HealthEnum2.LiveFood_sugar;
import com.gb.health.init.HealthEnum2.LiveFood_vegetable;
import com.gb.health.init.HealthEnum2.LiveFood_water;
import com.gb.health.init.HealthEnum2.LiveFood_weekKind;
import com.gb.health.init.HealthEnum2.Marriage;
import com.gb.health.init.HealthEnum2.Sleep_insomnia;
import com.gb.health.init.HealthEnum2.Sleep_time;
import com.gb.health.init.HealthEnum2.Sleep_wakeNumber;
import com.gb.health.init.HealthEnum2.Smoke_beginAge;
import com.gb.health.init.HealthEnum2.Smoke_condition;
import com.gb.health.init.HealthEnum2.Smoke_endAge;
import com.gb.health.init.HealthEnum2.Smoke_env;
import com.gb.health.init.HealthEnum2.Smoke_number;
import com.gb.health.init.HealthEnum2.Wine_Hz;
import com.gb.health.init.HealthEnum2.Wine_beer;
import com.gb.health.init.HealthEnum2.Wine_beginAge;
import com.gb.health.init.HealthEnum2.Wine_kind;
import com.gb.health.init.HealthEnum2.Wine_red;
import com.gb.health.init.HealthEnum2.Wine_white;
import com.gb.health.init.HealthEnum2.Wine_year;
import com.gb.health.init.HealthEnum2.Wine_yellow;
...
import com.gb.health.utils.EnumUtil2;
 ...
 */
public class GetUploadHealthC2 extends Commend{
	LogRecordInf lr = new LogRecordInf (GetUploadHealthC2.class);
	 ...
	 */
	public GetUploadHealthC2(JSONObject reqDate) {
		super(reqDate);
	...
	private TbHealthArchive getTbHealthArchive(){
		...
		if(json2.has("BaseMessage")){
			...
			if(json.has("b_education")){
				int b_education=json.getInt("b_education");
				System.out.println("学历："+b_education);
				int b_education1=(int) EnumUtil2.getEnumObject(b_education, Education.class).getValueCode();
				//int b_education1=  (int) EnumUtil2.getEnumObject(b_education,Education.class).getValueCode();
				System.out.println("学历编号"+b_education1);
			...
			if(json.has("b_insurance")){
				...
				//多选改成单选   2017.05.02 11:23            
				int b_insurance_Array=json.getInt("b_insurance");
				int b_insurance1= (Integer) EnumUtil2.getEnumObject(b_insurance_Array,Insurance.class).getValueCode();
			...
			if(json.has("b_marriage")){
				int b_marriage=	json.getInt("b_marriage");
				System.out.println(b_marriage);
				int b_marriage1= (Integer) EnumUtil2.getEnumObject(b_marriage,Marriage.class).getValueCode();
	...
	public  TbHealthLive getTbHealthLive() {
		...
		if(json2.has("LifeStyle")){
			...
			if(json.has("l_liveSport_count")){
				int l_liveSport_count=(int)EnumUtil2.getEnumObject(json.getInt("l_liveSport_count"), L_liveSport_count.class).getValueCode();
			...
			if(json.has("l_liveSport_minute")){
				int l_liveSport_minute=(int)EnumUtil2.getEnumObject(json.getInt("l_liveSport_minute"), L_liveSport_minute.class).getValueCode();
			...
			if(json.has("l_liveFood_structure")){
				int l_liveFood_structure=json.getInt("l_liveFood_structure");
				System.out.println(l_liveFood_structure);
				tbHealthLive.setlLivefoodStructure((Integer) EnumUtil2.getEnumObject(l_liveFood_structure, LiveFood_structure.class).getValueCode());
			...
			if(json.has("l_liveFood_dayKind")){
				int l_liveFood_dayKind=json.getInt("l_liveFood_dayKind");
				System.out.println(l_liveFood_dayKind);
				int l_liveFood_dayKind1=(Integer) EnumUtil2.getEnumObject(l_liveFood_dayKind,LiveFood_dayKind.class).getValueCode();
			...
			if(json.has("l_liveFood_weekKind")){
				int l_liveFood_weekKind=json.getInt("l_liveFood_weekKind");
				int l_liveFood_weekKind1=(Integer) EnumUtil2.getEnumObject(l_liveFood_weekKind,LiveFood_weekKind.class).getValueCode();
			...
			if(json.has("l_liveFood_primary")){
				int l_liveFood_primary=json.getInt("l_liveFood_primary");
				int l_liveFood_primary1=(Integer) EnumUtil2.getEnumObject(l_liveFood_primary,LiveFood_primary.class).getValueCode();
			...
			if(json.has("l_liveFood_potato")){
				int l_liveFood_potato=json.getInt("l_liveFood_potato");
				int l_liveFood_potato1=(Integer) EnumUtil2.getEnumObject(l_liveFood_potato,LiveFood_potato.class).getValueCode();
			...
			if(json.has("l_liveFood_bean")){
				int l_liveFood_bean=json.getInt("l_liveFood_bean");
				int l_liveFood_bean1=(Integer) EnumUtil2.getEnumObject(l_liveFood_bean,LiveFood_bean.class).getValueCode();
			...
			if(json.has("l_liveFood_vegetable")){
				int l_liveFood_vegetable=json.getInt("l_liveFood_vegetable");
				int l_liveFood_vegetable1=(Integer) EnumUtil2.getEnumObject(l_liveFood_vegetable,LiveFood_vegetable.class).getValueCode();
			...
			if(json.has("l_liveFood_fruit")){
				int l_liveFood_fruit=json.getInt("l_liveFood_fruit");
				int l_liveFood_fruit1=(Integer) EnumUtil2.getEnumObject(l_liveFood_fruit,LiveFood_fruit.class).getValueCode();
			...
			if(json.has("l_liveFood_milk")){
				int l_liveFood_milk=json.getInt("l_liveFood_milk");
				int l_liveFood_milk1=(Integer) EnumUtil2.getEnumObject(l_liveFood_milk,LiveFood_milk.class).getValueCode();
			...
			if(json.has("l_liveFood_nut")){
				int l_liveFood_nut=json.getInt("l_liveFood_nut");
				int l_liveFood_nut1=(Integer) EnumUtil2.getEnumObject(l_liveFood_nut,LiveFood_nut.class).getValueCode();
			...
			if(json.has("l_liveFood_salt")){
				int l_liveFood_salt=json.getInt("l_liveFood_salt");
				int l_liveFood_salt1=(Integer) EnumUtil2.getEnumObject(l_liveFood_salt,LiveFood_salt.class).getValueCode();
			...
			if(json.has("l_liveFood_meat")){
				int l_liveFood_meat=json.getInt("l_liveFood_meat");
				int l_liveFood_meat1=(Integer) EnumUtil2.getEnumObject(l_liveFood_meat,LiveFood_meat.class).getValueCode();
			...
			if(json.has("l_liveFood_fish")){
				int l_liveFood_fish=json.getInt("l_liveFood_fish");
				int l_liveFood_fish1=(Integer) EnumUtil2.getEnumObject(l_liveFood_fish,LiveFood_fish.class).getValueCode();
			...
			if(json.has("l_liveFood_egg")){
				int l_liveFood_egg=json.getInt("l_liveFood_egg");
				int l_liveFood_egg1=(Integer) EnumUtil2.getEnumObject(l_liveFood_egg,LiveFood_egg.class).getValueCode();
			...
			if(json.has("l_liveFood_oil")){
				int l_liveFood_oil=json.getInt("l_liveFood_oil");
				int l_liveFood_oil1=(Integer) EnumUtil2.getEnumObject(l_liveFood_oil,LiveFood_oil.class).getValueCode();
			...
			if(json.has("l_liveFood_sugar")){
				int l_liveFood_sugar=json.getInt("l_liveFood_sugar");
				int l_liveFood_sugar1=(Integer) EnumUtil2.getEnumObject(l_liveFood_sugar,LiveFood_sugar.class).getValueCode();
			...
			if(json.has("l_liveFood_water")){
				...
				int l_liveFood_water=json.getInt("l_liveFood_water");
				int l_liveFood_water1=(Integer) EnumUtil2.getEnumObject(l_liveFood_water,LiveFood_water.class).getValueCode();
			...
			if(json.has("l_smoke_condition")){
				...
				int l_smoke_condition_number=json.getInt("l_smoke_condition");
				int l_smoke_condition1=(Integer) EnumUtil2.getEnumObject(l_smoke_condition_number,Smoke_condition.class).getValueCode();
				String l_smoke_condition=(String)EnumUtil2.getEnumObject(l_smoke_condition_number,Smoke_condition.class).getValue();
				...
				if("从不吸烟".equals(l_smoke_condition)){
					...
					int l_smoke_env=json.getInt("l_smoke_env");
						int l_smoke_env1=(Integer) EnumUtil2.getEnumObject(l_smoke_env,Smoke_env.class).getValueCode();
					...
					if(json.has("l_smoke_beginAge")){
						int l_smoke_beginAge=json.getInt("l_smoke_beginAge");
						int l_smoke_beginAge1=(Integer) EnumUtil2.getEnumObject(l_smoke_beginAge,Smoke_beginAge.class).getValueCode();
					...
					if(json.has("l_smoke_number")){
						int l_smoke_number=json.getInt("l_smoke_number");
						int l_smoke_number1=(Integer) EnumUtil2.getEnumObject(l_smoke_number,Smoke_number.class).getValueCode();
					...
					if(json.has("l_smoke_endAge")){
						int l_smoke_endAge=json.getInt("l_smoke_endAge");
						int l_smoke_endAge1=(Integer) EnumUtil2.getEnumObject(l_smoke_endAge,Smoke_endAge.class).getValueCode();
			...
			if(json.has("l_wine_Hz")){
				int l_wine_Hznumber=json.getInt("l_wine_Hz");
				int l_wine_Hz1=(Integer) EnumUtil2.getEnumObject(l_wine_Hznumber,Wine_Hz.class).getValueCode();
				System.out.println(l_wine_Hz1);
				String l_wine_Hz=(String)EnumUtil2.getEnumObject(l_wine_Hznumber,Wine_Hz.class).getValue();
				...
				if("从不".equals(l_wine_Hz)){
					...
					if(json.has("l_wine_beginAge")){
						...
						int l_wine_beginAge=json.getInt("l_wine_beginAge");
						int l_wine_beginAge1=(Integer) EnumUtil2.getEnumObject(l_wine_beginAge,Wine_beginAge.class).getValueCode();
					...
					if(json.has("l_wine_kind")){
						int l_wine_kind=json.getInt("l_wine_kind");
						int l_wine_kind1=(Integer) EnumUtil2.getEnumObject(l_wine_kind,Wine_kind.class).getValueCode();
					...
					if(json.has("l_wine_beer")){
						...
						int l_wine_beer=json.getInt("l_wine_beer");
						int l_wine_beer1=(Integer) EnumUtil2.getEnumObject(l_wine_beer,Wine_beer.class).getValueCode();
					...
					if(json.has("l_wine_white")){
						...
						int l_wine_white=json.getInt("l_wine_white");
						int l_wine_white1=(Integer) EnumUtil2.getEnumObject(l_wine_white,Wine_white.class).getValueCode();
					...
					if(json.has("l_wine_red")){
						...
						int l_wine_red=json.getInt("l_wine_red");
						int l_wine_red1=(Integer) EnumUtil2.getEnumObject(l_wine_red,Wine_red.class).getValueCode();
					...
					if(json.has("l_wine_yellow")){
						...
						int l_wine_yellow=json.getInt("l_wine_yellow");
						int l_wine_yellow1=(Integer) EnumUtil2.getEnumObject(l_wine_yellow,Wine_yellow.class).getValueCode();
					...
					if(json.has("l_wine_year")){
						...
						int l_wine_year=json.getInt("l_wine_year");
						int l_wine_year1=(Integer) EnumUtil2.getEnumObject(l_wine_year,Wine_year.class).getValueCode();
			...
			if(json.has("l_sleep_time")){
				...
				int l_sleep_time=json.getInt("l_sleep_time");
				int l_sleep_time1=(Integer) EnumUtil2.getEnumObject(l_sleep_time,Sleep_time.class).getValueCode();
			...
			if(json.has("l_sleep_wakeNumber")){
				...
				int l_sleep_wakeNumber=json.getInt("l_sleep_wakeNumber");
				int l_sleep_wakeNumber1=(Integer) EnumUtil2.getEnumObject(l_sleep_wakeNumber,Sleep_wakeNumber.class).getValueCode();
			...
			if(json.has("l_sleep_insomnia")){
				...
				int l_sleep_insomnia=json.getInt("l_sleep_insomnia");
				int l_sleep_insomnia1=(Integer) EnumUtil2.getEnumObject(l_sleep_insomnia,Sleep_insomnia.class).getValueCode();
